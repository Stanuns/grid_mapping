//Publish transformation between odom and base_footprint
...
int main(int argc, char **argv)
{
  ...
  // 创建一个OdomTfPub节点
  auto node = std::make_shared<OdomTfPub>("odom_tf_pub_node");
